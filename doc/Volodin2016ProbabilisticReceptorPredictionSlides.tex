...
Предсказание взаимодействия двух типов молекул: лиганд и рецепторов. Необходимо дать оценку связывания.
\begin{block}{Проблема}
События реакции лиганда с различными рецепторами не независимы. Классификатор, не учитывающий их, имеет плохой результат.
...
\begin{block}{Восстановление распределения}
...
%	Требуется минимизировать $Q$:
	$$\w^*=\underset{{\w\in\W}}{\arg\max}\ln P(\fs|\w,\mathfrak{L})$$
	
\end{block}
\begin{block}{Бинарный классификатор}
	\begin{enumerate}
...
\begin{block}{Планы на будущее}
	\begin{enumerate}
		...
		\item Выбор правильного алгоритма
